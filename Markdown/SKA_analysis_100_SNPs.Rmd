...
```{r}
#Read in our novel ST designations

mlst_pubmlst <- read_delim("pubMLST/mlst.txt", delim = "\t")

mlst_pubmlst <- mlst_pubmlst %>% rename("name" = isolate)

inner_join(ST_list, mlst_pubmlst, by = "name")
```
...
write_delim(supp_table_x, "2022/delims/Supplementary_table_1.txt")
...
#to save as pdf 
pdf(file = "2022/figures/Alluvial_plot_NCBI_Citros.pdf", width = 25, height = 15, useDingbats = FALSE)
...
ggsave(plot_w_legend, filename = "/Users/131785/Dropbox/PostDoc/Manuscripts/2021/Citrobacter/Citrobacter_analysis/2022/images/SKA_distances_WW_gull_ST_overlap.pdf", height = 8.27, width = 11.69)
```
...
ggsave(int_plots, filename = "/Users/131785/Dropbox/PostDoc/Manuscripts/2021/Citrobacter/Citrobacter_analysis/2022/images/internal_SKA_distances_WW_gull_ST_overlap.pdf", height = 8.27, width = 11.69)
```
...
ggsave(ext_plots, filename = "/Users/131785/Dropbox/PostDoc/Manuscripts/2021/Citrobacter/Citrobacter_analysis/2022/images/externalSKA_distances_WW_gull_ST_overlap.pdf", height = 8.27, width = 11.69)
```
