...
pMLST_path <- "2022//results/summaries/pMLST.txt"
mlst_path <- "2022//results/summaries/mlst.txt"
tree_path <- "2022//results/summaries/trees/mashtree_100_BS_full_pass_QC.tree"
...
public_metadata_path <- "Metadata_public_genomes.xlsx"
...
write_delim(gull_ST_overlap, "../delims/gull_ST_overlap", delim = "\t")
...
write_delim(ww_ST_overlap, "../delims/ww_ST_overlap", delim = "\t")
...
gull_p2 + scale_x_continuous(limits = c(NA, 0.125))
```
