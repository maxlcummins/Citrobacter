...
pubmlst <- pubmlst %>% rename('name' = isolate) %>% filter(name %in% QC_pass$name) %>% select(name, 21:28)

#Change column names
colnames(pubmlst) <- c('name', 'allele1_', 'allele2_', 'allele3_', 'allele4_', 'allele5_', 'allele6_', 'allele7_', 'ST_pub')

metadata %>% select(name, ST_new, ST) %>% right_join(pubmlst, by = "name")
```
...
p2 <- p + geom_strip(
        ...
        geom_strip(
                species_coord$firstocc[8],
                species_coord$lastocc[8],
                barsize = strip_barsize,
                color = species_coord$color[8],
                label = paste0(species_coord$bacsort_species[8], "*"),
                fontsize = strip_fontsize,
                offset = strip_offset,
                offset.text = strip_text_offset,
                hjust = strip_text_hjust
        ...
        geom_strip(
                species_coord$firstocc[9],
                species_coord$lastocc[9],
                barsize = strip_barsize,
                color = species_coord$color[9],
                label = paste0(species_coord$bacsort_species[9], "*"),
                fontsize = strip_fontsize,
                offset = strip_offset,
                offset.text = strip_text_offset,
                hjust = strip_text_hjust
        ...
        geom_strip(
                species_coord$firstocc[10],
                species_coord$lastocc[10],
                barsize = strip_barsize,
                color = species_coord$color[10],
                label = paste0(species_coord$bacsort_species[10], "*"),
                fontsize = strip_fontsize,
                offset = strip_offset,
                offset.text = strip_text_offset,
                hjust = strip_text_hjust
        ...
        geom_strip(
                species_coord$firstocc[11],
                species_coord$lastocc[11],
                barsize = strip_barsize,
                color = species_coord$color[11],
                label = paste0(species_coord$bacsort_species[11], "*"),
                fontsize = strip_fontsize,
                offset = strip_offset,
                offset.text = strip_text_offset,
                hjust = strip_text_hjust
        ...
        geom_strip(
                species_coord$firstocc[12],
                species_coord$lastocc[12],
                barsize = strip_barsize,
                color = species_coord$color[12],
                label = paste0(species_coord$bacsort_species[12], "*"),
                fontsize = strip_fontsize,
                offset = strip_offset,
                offset.text = strip_text_offset,
                hjust = strip_text_hjust
...
p2 <- p2  + scale_x_continuous(limits = c(NA, 0.1125))
```

```{r, echo=FALSE, fig.height=8, fig.width=12}
ggsave("2022/images/Figure_1_Internal_tree_w_refs.pdf", p2, device = "pdf",  height = 8.27, width = 11.69)
```
